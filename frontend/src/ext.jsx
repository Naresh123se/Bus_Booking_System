    ...
    geocoder.geocode({ location: latLng }, (results, status) => {
      if (status === 'OK') {
        if (results[0]) {
          ...
          setSelectedLocation(address); // Update selected location
          const sourceInput = document.getElementById('source');
          const destInput = document.getElementById('dest');
          if (sourceInput === document.activeElement) {
            sourceInput.value = address;
          } else if (destInput === document.activeElement) {
    ...
    <div>
      ...
      <div className="container">
        ...
        <div className='flex'>
          ...
          <div id="photo-container" style={{ height: '500px', width: '50%', overflow: 'auto' }}>
            {/* Content goes here */}
          </div>
        </div>
