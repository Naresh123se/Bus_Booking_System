...
const BusSeatSelection = () => {
  ...
  const bookedSeats = [2, 3, 4, 10, 15]; // Update this array based on the seats that are already booked
    ...
    <>
      <div className='    '>
        ...
        <div className="flex">
          ...
          <div className="border pl-2  w-52">
            <div className="mt-3">
            ...
            <Button sx={{ bgcolor: '' }} className=" bg-blue-500 text-white rounded px-4 py-2 mt-4" onClick={handleClearSelection}>
              Clear Selection
            </Button>
            <br />
